...
The program can be run on a platform of your choice in a provided *Conda* environment. Inside of the repo run `conda env create --file SMITH.yml`. 
...
#### `CCF.png` 
How big a portion of a population a subclone captures.
![CCF](./doc/img/CCF.png)
