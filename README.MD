...
The main and supplementary figures for the 2022 publication (Streck, Kaufmann and Schwarz) are created using the notebooks in the `smith/article_figures` directory.

Most plotting data is provided in `smith/article_figures/data` and was created from raw data using `smith/article_figures/scripts/create_plotting_data_from_raw.py`.
